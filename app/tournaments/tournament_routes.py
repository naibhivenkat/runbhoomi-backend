...
def generate_fixtures(tournament_id: int, db: Session = Depends(get_db)):
    ...
    # ✅ DELETE OLD GROUPS (VERY IMPORTANT 🔥)
    db.query(GroupTeam).delete(synchronize_session=False)
